...
if len(tle_lines) < 2:
    ...
    #FILTRO DE KALMAN EXTENDIDO BAD GYROS BAD MAGNETO
    for i in range(len(t_aux)-1):
        ...
        if abs(q_k[3])>abs(q_k[2]) and abs(q_k[3])>abs(q_k[1]) and abs(q_k[3])>abs(q_k[0]):
            q_k[3] = np.sqrt(1-(q_k[0])-(q_k[1])-(q_k[2]))
            ...
            q_1_pos = q_k_pos[0]/np.sqrt(q_k[3]+q_k_pos[0]+q_k_pos[1]+q_k_pos[2])
            q_2_pos = q_k_pos[1]/np.sqrt(q_k[3]+q_k_pos[0]+q_k_pos[1]+q_k_pos[2])
            q_3_pos = q_k_pos[2]/np.sqrt(q_k[3]+q_k_pos[0]+q_k_pos[1]+q_k_pos[2])
            q_4_pos = q_k[3] / np.sqrt(q_k[3]+q_k_pos[0]+q_k_pos[1]+q_k_pos[2])
            ...
            q_k[2] = np.sqrt(1-(q_k[0])-(q_k[1])-(q_k[3]))
            ...
            q_1_pos = q_k_pos[0]/np.sqrt(q_k[2]+q_k_pos[0]+q_k_pos[1]+q_k_pos[2])
            q_2_pos = q_k_pos[1]/np.sqrt(q_k[2]+q_k_pos[0]+q_k_pos[1]+q_k_pos[2])
            q_4_pos = q_k_pos[2]/np.sqrt(q_k[2]+q_k_pos[0]+q_k_pos[1]+q_k_pos[2])
            q_3_pos = q_k[2] / np.sqrt(q_k[2]+q_k_pos[0]+q_k_pos[1]+q_k_pos[2])
            P_k_pos= P_posteriori(K_k,H_k,P_k_priori)
            ...
            q_k[1] = np.sqrt(1-(q_k[0])-(q_k[2])-(q_k[3]))
            ...
            q_1_pos = q_k_pos[0]/np.sqrt(q_k[1]+q_k_pos[0]+q_k_pos[1]+q_k_pos[2])
            q_3_pos = q_k_pos[1]/np.sqrt(q_k[1]+q_k_pos[0]+q_k_pos[1]+q_k_pos[2])
            q_4_pos = q_k_pos[2]/np.sqrt(q_k[1]+q_k_pos[0]+q_k_pos[1]+q_k_pos[2])
            q_2_pos = q_k[1] / np.sqrt(q_k[1]+q_k_pos[0]+q_k_pos[1]+q_k_pos[2])
            P_k_pos= P_posteriori(K_k,H_k,P_k_priori)
            ...
            q_k[0] = np.sqrt(1-(q_k[1])-(q_k[2])-(q_k[3]))
            ...
            q_2_pos = q_k_pos[0]/np.sqrt(q_k[0]+q_k_pos[0]+q_k_pos[1]+q_k_pos[2])
            q_3_pos = q_k_pos[1]/np.sqrt(q_k[0]+q_k_pos[0]+q_k_pos[1]+q_k_pos[2])
            q_4_pos = q_k_pos[2]/np.sqrt(q_k[0]+q_k_pos[0]+q_k_pos[1]+q_k_pos[2])
            q_1_pos = q_k[0] / np.sqrt(q_k[0]+q_k_pos[0]+q_k_pos[1]+q_k_pos[2])
            P_k_pos= P_posteriori(K_k,H_k,P_k_priori)
    ...
    for i in range(len(t_aux)-1):
        Xk = f(t_aux[i],q_k00g[-1],q_k10[-1],q_k20g[-1],q_k30g[-1],w_k00[-1], w_k10g[-1], w_k20g[-1])
        Xk = np.array(Xk)
        q_k = [Xk[0],Xk[1],Xk[2],Xk[3]]
        w_k = [Xk[4],Xk[5],Xk[6]]
